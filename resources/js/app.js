...
/**
 * The following block of code may be used to automatically register your Vue
 * components. It will recursively scan this directory for the Vue components
...
const app = new Vue({
    ...
    methods: {
        fetchUsers: function(){
            axios.get('/api/userVueSearch').then((res) => {
                this.users = res.data;
            });
        }
    },
